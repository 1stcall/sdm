...
./bf_rpi4b-1.sh
./extfilesys.sh -v -v -o output/rpi4b-1-${RELEASE}-out.img /srv/netboot d21c0840 &
./bf_rpi4b-2.sh
./extfilesys.sh -v -v -o output/rpi4b-2-${RELEASE}-out.img /srv/netboot acdce532 &
./bf_rpi4b-3.sh
./extfilesys.sh -v -v -o output/rpi4b-3-${RELEASE}-out.img /srv/netboot 9fb41f35 &
./bf_rpi4b-4.sh
./extfilesys.sh -v -v -o output/rpi4b-4-${RELEASE}-out.img /srv/netboot 9210668e &
#
wait
#
