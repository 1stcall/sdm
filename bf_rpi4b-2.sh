...
declare hostName="rpi4b-2"
declare serialNo="acdce532"
declare ipAddress="192.168.1.12"
#
...
sdmCmd="${sdmCmd} --batch"
sdmCmd="${sdmCmd} --plugin ${baseDirectory}/local-plugins/50setnfsroot:assetDir=\"${baseDirectory}/assets\"|DEBUG=${DEBUG}|LOGPREFIX=${scriptName}|serialNo=${serialNo}"
